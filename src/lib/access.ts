...
const ACCESS_MATRIX: Record<string, Record<string, AccessLevel>> = {
  SUPER_ADMIN: {
    dashboard: "write", production: "write", quality: "write",
    inventory: "write", dispatch: "write", purchase: "write",
    stores: "write", hr: "write", accounts: "write",
    maintenance: "write", users: "write", audit: "write",
    reports: "write", masters: "write", stock: "write",
  ...
  GENERAL_MANAGER: {
    dashboard: "write", production: "write", quality: "write",
    maintenance: "write", stores: "write", inventory: "write",
    dispatch: "write", purchase: "write", lotrac: "write",
    reports: "write", stock: "write", sales: "write",
  ...
  PRODUCTION_MANAGER: {
    dashboard: "write", production: "write",
  ...
  DISPATCH_MANAGER: {
    dashboard: "write", dispatch: "write", lotrac: "write",
...
export const DASHBOARD_ONLY_ROLES = new Set([
  "MACHINE_OPERATOR", "SECURITY_GATE", "AUDITOR",
]);
...
export function finalAccess(
  ...
  if (!ctx.isSuperAdmin && !SYSTEM_MODULES.has(key) && ctx.companyModules !== null) {
    if (ctx.companyModules[key] !== true) {
      return { granted: false, reason: `Module "${key}" not enabled for your company`, level: "none" };
    }
  }
