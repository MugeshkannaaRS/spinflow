...
import { FileText, TrendingUp, FlaskConical, Truck, IndianRupee, Download, Loader2 } from "lucide-react";
...
function ReportsPage() {
  ...
  const { data } = useQuery({ queryKey: ["report-data"], queryFn: reportsApi.getSummary });
    ...
    <>
      ...
      >
        <div className="flex items-center gap-1">
          ...
          >
            {exporting === "Production PDF" ? <Loader2 className="size-3 animate-spin mr-1" /> : <Download className="size-3 mr-1" />}
            Prod PDF
          </Button>
          <Button
            variant="outline"
            ...
            disabled={exporting !== null}
          >
            {exporting === "Production XLSX" ? <Loader2 className="size-3 animate-spin mr-1" /> : <Download className="size-3 mr-1" />}
            Prod XLSX
          </Button>
          <Button
            variant="outline"
            ...
            disabled={exporting !== null}
          >
            {exporting === "Dispatch PDF" ? <Loader2 className="size-3 animate-spin mr-1" /> : <Download className="size-3 mr-1" />}
            Dispatch PDF
          </Button>
        </div>
      </Topbar>
        ...
        <div className="grid gap-4 md:grid-cols-4">
          <Card>
            <CardContent className="p-5">
              <div className="text-xs uppercase text-muted-foreground font-medium">Production</div>
          ...
          <Card>
            <CardContent className="p-5">
              ...
              <div className="text-xs text-muted-foreground mt-1">
                {data.dispatchSummary.pending} pending · {data.dispatchSummary.inTransit} in transit
              </div>
            </CardContent>
          </Card>
          <Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid gap-4 md:grid-cols-4">
              ...
              <div className="rounded-lg border p-4">
                <div className="text-xs text-muted-foreground uppercase font-medium">Purchases</div>
                <div className="text-xl font-semibold mt-1">
