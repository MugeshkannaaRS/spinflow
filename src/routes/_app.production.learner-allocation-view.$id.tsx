...
export const Route = createFileRoute("/_app/production/learner-allocation-view/$id")({
  head: () => ({ meta: [{ title: "View Allocation — SpinFlow ERP" }] }),
        ...
        <div className="print:hidden sticky top-0 z-10 bg-white border-b border-gray-200 shadow-sm px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-base font-bold text-gray-900">
              Manpower Allocation — {alloc.allocation_date}
