...
function InventoryPage() {
  ...
  const lotsQ = useQuery({ queryKey: ["inventory-lots"], queryFn: inventoryApi.getLots });
  const transfersQ = useQuery({ queryKey: ["stock-transfers"], queryFn: inventoryApi.getTransfers });
  ...
  useEffect(() => { setFilteredTransfers(transfers); }, [transfers]);

  const totalStock = lots.reduce((s, l) => s + l.quantity, 0);
              ...
              <CardContent>
                <ExcelColumnFilter
                  ...
                  columns={[
                    ...
                    { key: "location" as const, label: "Location", placeholder: "Filter location..." },
              ...
              <CardContent>
                <ExcelColumnFilter
                  ...
                  columns={[
                    ...
                    { key: "fromLocation" as const, label: "From", placeholder: "Filter from..." },
                    { key: "toLocation" as const, label: "To", placeholder: "Filter to..." },
                    { key: "transferredBy" as const, label: "By", placeholder: "Filter transferred by..." },
                    { key: "status" as const, label: "Status", placeholder: "Filter status..." },
                  ]}
                />
                <Table>
