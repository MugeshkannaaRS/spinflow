  ...
  return (
    <div className="space-y-6 p-6 max-w-[1200px] mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <button
          onClick={() => navigate({ to: "/admin/modules" })}
        ...
        <div className="divide-y divide-gray-50 dark:divide-slate-700/50">
          {isLoading ? (
            ...
            data.companies.map((company: any) => (
              <div
                key={company.id}
                className="flex items-center justify-between px-5 py-4 hover:bg-gray-50 dark:hover:bg-slate-700/50"
              >
                <div>
    ...
    <div className="space-y-3 mt-2">
      ...
      <div className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="e.g. SpinFlow Textiles Pvt Ltd"
        />
      </div>
      <div className="space-y-1.5">
        <Label>GSTIN</Label>
