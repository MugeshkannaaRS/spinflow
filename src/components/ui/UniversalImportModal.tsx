...
export function UniversalImportModal({
  ...
  const FIELD_MAP: Record<string, Record<string, string>> = {
    ...
    maintenance_schedules: {
      ...
      "SL No": "sl_no",
      Frequency: "frequency",
      "Frequency Days": "frequency_days",
      "Lubricant Name": "lubricant_name",
      "Lubricant Quantity": "lubricant_quantity",
      "Manpower Count": "manpower_count",
      "Machine Count": "machine_count",
      "Is Active": "is_active",
      "Machine Line Code": "machine_line_code",
      "Line Code": "machine_line_code",
      "Opening Dia": "opening_dia_mm",
      "Opening Dia (mm)": "opening_dia_mm",
      "Current Dia": "current_dia_mm",
      "Grinding Freq Days": "grinding_freq_days",
      "Last Grinding Date": "last_grinding_date",
    },
    masters_machines: {},
    masters_customers: {},
  };
