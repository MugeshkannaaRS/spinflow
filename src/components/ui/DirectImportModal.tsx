...
const HEADER_ALIASES: Record<string, Record<string, string>> = {
  maintenance_schedules: {
    ...
    // enrichment variants — include SELF-mappings (exact field name → field)
    // so these persist even when the server's stored column-config for this
    // table predates the enrichment columns (otherwise the header is dropped).
    ...
    lubricant_quantity: "lubricant_quantity",
