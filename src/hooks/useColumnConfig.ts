...
const DEFAULT_CONFIGS: Record<string, ColumnConfig[]> = {
  hr_employees: [
    ...
    col("employee_code", "Emp Code", "text", true, true, 2, "Personal"),
    col("full_name", "Full Name", "text", true, true, 3, "Personal"),
    col("gen", "Gender (Full)", "text", true, false, 4, "Personal"),
    col("gender", "Gender", "dropdown", true, false, 5, "Personal"),
    col("grade", "Grade", "text", true, false, 6, "Personal"),
    ...
    col("date_of_joining", "Joining Date", "date", true, false, 10, "Job"),
  ...
  quality_tests: [
    ...
    col("lot_no", "Lot No", "text", true, false, 4),
    col("machine_code", "Machine", "dropdown", true, false, 5),
    col("sample_ref", "Sample Ref", "text", true, false, 6),
    col("result", "Result", "number", true, false, 7),
    col("unit", "Unit", "text", true, false, 8),
    col("standard", "Standard", "number", true, false, 9),
    col("status", "Status", "dropdown", true, false, 10),
    col("tested_by", "Tested By", "text", true, false, 11),
  ],
  quality_approvals: [
  ...
  dispatch_trips: [
    ...
    col("vehicle_no", "Vehicle No", "text", true, false, 3),
    col("driver_name", "Driver", "text", true, false, 4),
    col("customer", "Customer", "text", true, false, 5),
    col("lot_no", "Lot", "text", true, false, 6),
    col("destination_name", "Destination", "text", true, false, 7),
    col("planned_bags", "Planned Bags", "number", true, false, 8),
    col("planned_weight_kg", "Planned (kg)", "number", true, false, 9),
    col("loaded_bags", "Loaded Bags", "number", true, false, 10),
    col("loaded_weight_kg", "Loaded (kg)", "number", true, false, 11),
    col("delivered_weight_kg", "Delivered (kg)", "number", true, false, 12),
    col("status", "Status", "dropdown", true, false, 13),
  ],
  ...
  stores_spares: [
    ...
    col("current_stock", "Current Stock", "number", true, false, 5),
    col("min_stock", "Min Stock", "number", true, false, 6),
    col("max_stock", "Max Stock", "number", true, false, 7),
    col("reorder_level", "Reorder Level", "number", true, false, 8),
    col("unit", "Unit", "text", true, false, 9),
    col("location", "Location", "text", true, false, 10),
    col("vendor", "Vendor", "text", true, false, 11),
    col("is_active", "Status", "boolean", true, false, 12),
  ],
  stores_issues: [
    col("date", "Date", "date", true, true, 1),
  ...
  maintenance_schedules: [
    ...
    // PM enrichment fields (accepted by ScheduleBulkItem; imported via DirectImportModal)
    col("department", "Department", "text", true, false, 8),
    col("frequency", "Frequency", "text", true, false, 9),
    col("sl_no", "SL No", "number", true, false, 10),
    col("manpower_count", "Manpower Count", "number", true, false, 11),
    col("machine_count", "Machine Count", "number", true, false, 12),
    col("lubricant_name", "Lubricant Name", "text", true, false, 13),
    col("lubricant_quantity", "Lubricant Quantity", "text", true, false, 14),
    col("machine_line_code", "Machine Line Code", "text", true, false, 15),
    col("opening_dia_mm", "Opening Dia (mm)", "number", true, false, 16),
    col("current_dia_mm", "Current Dia (mm)", "number", true, false, 17),
    col("grinding_freq_days", "Grinding Freq Days", "number", true, false, 18),
    col("last_grinding_date", "Last Grinding Date", "date", true, false, 19),
  ],
  accounts_invoices: [
