...
test('logged-in /admin/users captures production Users evidence', async ({ page }) => {
  const evidenceDir = path.resolve('e2e', 'prod-evidence', 'admin_users');
  ...
  await page.goto('/admin/users', { waitUntil: 'networkidle', timeout: 120_000 });
