...
class PayrollMonth(Base):
    ...
    total_pf: Mapped[float] = mapped_column(Float, default=0.0)
    total_esic: Mapped[float] = mapped_column(Float, default=0.0)
...
class PayslipEntry(Base):
    ...
    gross_wage: Mapped[float] = mapped_column(Float, default=0.0)
    pf_employee: Mapped[float] = mapped_column(Float, default=0.0)
    pf_employer: Mapped[float] = mapped_column(Float, default=0.0)
    esic_employee: Mapped[float] = mapped_column(Float, default=0.0)
    esic_employer: Mapped[float] = mapped_column(Float, default=0.0)
    other_deductions: Mapped[float] = mapped_column(Float, default=0.0)
    net_wage: Mapped[float] = mapped_column(Float, default=0.0)
