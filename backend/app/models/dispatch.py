...
class Dispatch(TimestampMixin, Base):
    ...
    # Document fields (Delivery Challan / Gate Pass / Weight Report)
    consignee_address: Mapped[Optional[str]] = mapped_column(String(400), nullable=True)
    item_specification: Mapped[Optional[str]] = mapped_column(String(200), nullable=True)
    material_description: Mapped[Optional[str]] = mapped_column(String(200), nullable=True)
    grade: Mapped[Optional[str]] = mapped_column(String(20), nullable=True)
    unit: Mapped[Optional[str]] = mapped_column(String(20), nullable=True)
    pi_do_no: Mapped[Optional[str]] = mapped_column(String(60), nullable=True)
    ...
    weight_serial: Mapped[Optional[str]] = mapped_column(String(40), nullable=True)
    gate_pass_no: Mapped[Optional[str]] = mapped_column(String(60), nullable=True)
    prepared_by: Mapped[Optional[str]] = mapped_column(String(200), nullable=True)
    remarks: Mapped[Optional[str]] = mapped_column(String(400), nullable=True)
