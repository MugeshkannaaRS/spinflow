...
ACCESS_MATRIX: dict[str, dict[str, Union[bool, str]]] = {
    ...
    "GENERAL_MANAGER": {"dashboard": True, "production": True, "quality": True, "inventory": True, "dispatch": True, "purchase": True, "stores": True, "hr": "read", "accounts": "read", "maintenance": True, "reports": True, "audit": "read", "stock": True, "sales": True, "payroll": "read"},
    ...
    "ACCOUNTANT": {"dashboard": True, "accounts": True, "purchase": "read", "dispatch": "read", "reports": True, "sales": "read", "payroll": True},
